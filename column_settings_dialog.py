# column_settings_dialog.py — порядок и видимость столбцов таблицы (режим «Инвест»)
...
class ColumnSettingsDialog(QtWidgets.QDialog):
    """Окно настроек: порядок и видимость столбцов таблицы (режим Инвест)."""
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Столбцы таблицы")
        apply_dialog_theme(self)

        layout = QtWidgets.QVBoxLayout(self)
        layout.addWidget(QtWidgets.QLabel("Порядок и видимость столбцов в режиме «Инвест»:"))
