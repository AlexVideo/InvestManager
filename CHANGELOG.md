...
### Добавлено
- **Адаптация под мелкие экраны:** настройки внешнего вида в диалоге «Настройки» → блок «Внешний вид».
  - Три режима: **Обычный**, **Компактный (мелкий экран)**, **Мелкий (маленький экран)** — уменьшаются шрифты и отступы кнопок.
  - Настройки хранятся в файле **data/app_settings.json** в папке приложения; при запуске считываются, при смене в настройках — перезаписываются.
  - Смена режима применяется сразу, без перезапуска программы.
