...
**Версия 0.7.0** — локальный учёт инвест-проектов, маркетинга, договоров, корректировок, ревизий, а также учёт договоров и актов по услугам и работам.
...
4. **Дальше**: запускайте **push_to_github.bat** — он сделает коммит (с версией из `version.py`), создаст тег версии (например **v0.7.0**) и отправит всё на GitHub.
